...
EMPLOYEES = {
    ...
    "app_development": Employee("app_development", "digital_services", ("app scope", "technical plan", "estimate")),
    "customer_support": Employee("customer_support", "sales_crm", ("faq", "customer care", "escalation")),
    ...
    "security": Employee("security", "finance_legal", ("security review", "risk escalation")),
